...
namespace Editor.Scripts.EditorLevel
{
    ...
    public class Voxel : MonoBehaviour
    {
        ...
        public static Voxel Create(TerrainGeneration.ModelLevel.Voxel voxelSO, GameObject parentGameObject,
            TerrainBuilder terrainBuilder, ThreeDimensionalMatrix<Voxel> voxelMatrix)
        {
            ...
            voxel._terrainBuilder = terrainBuilder;
            ...
            {
                var side = Side.Create(sideSO, voxelGameObject, terrainBuilder);
