...
namespace Editor.Scripts.FSM.States.VoxelEditor
{
    public class Brush
    {
        ...
        public Vector3Int Position
        {
            ...
            {
                _position = value;
                _worldPosition = _terrainBuilder.levelSO.VoxelToWorldPosition(_position);
            }
        }
        ...
        public VoxelType VoxelType
        {
            ...
            set
            {
                ...
                var shape = CenteredVoxel.Shape(_voxelType, _terrainBuilder.levelSO.voxelSize);
                _mesh = shape.MeshInfo.Mesh;
            }
        }

        public Brush(VoxelType voxelType, Editor.Scripts.TerrainBuilder terrainBuilder)
        {
        ...
        public void UseBrush(Shape shape)
        {
            ...
            foreach (var direction in TerrainGeneration.ModelLevel.Voxel.SideDirections)
            {
                ...
                var neighbourVoxel = _terrainBuilder.EditorLevel.VoxelMatrix[neighbourVoxelPosition];
